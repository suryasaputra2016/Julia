...
# ╔═╡ 719bf0f0-4d8f-11ec-08b1-492488fe9ada
using Javis

# ╔═╡ 087642b9-b444-490f-a361-f873744d4a5e
function ground(args...)
	background("black")
	sethue("white")
end

# ╔═╡ af93c962-da5f-4371-ba0c-fd1d8e469a78
frames = 1

# ╔═╡ 83afef93-65ee-42eb-b021-157bfca5eb4f
begin
	myvideo = Video(500,500)
	Background(1:frames, ground)

	Object(1:frames, JLine(Point(250,250), color="yellow", linewidth=3))

	Object(JCircle(O, 50, color = "red", linewidth = 3, action = :stroke))

	Object(JEllipse(Point(0,150),100,50, color = "green", action = :fill))

	Object(JPoly([Point(50,50), Point(50,150), Point(150,150)], color="white", linewidth=3))
...
git-tree-sha1 = "16d386dab973f1fd7f5b42254962b14cbb4694c4"
