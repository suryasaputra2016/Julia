...
# ╔═╡ 6e49eda0-4e7d-11ec-2be5-ebc840629005
using Javis

# ╔═╡ 066370e0-d3a6-4e94-bb36-0f165af1ada7
function ground(args...)
	background("white")
	sethue("black")
end

# ╔═╡ 3f95f19e-2cfd-4060-a6f9-e1b4e3a23b27
begin
	myvideo = Video(600,600)
	Background(1:100, ground)
	# Object(1:100, JCircle(O, 25, color="red", action= :fill))
	x = -200
	y = 0
	vₓ = 10
	v = -20
	...
	for i ∈ 1:100
		...
		y = y + v
		v = v + a
		Object(i:i, JCircle(Point(x,y), 25, color="red", action= :fill))
	end
	render(myvideo, pathname="playing_for.gif")
end

# ╔═╡ 53a3abd7-7000-444a-b85e-301d087eedf7
?JCircle
