...
# ╔═╡ bae115c7-8572-473a-9adf-75b24f828b3f
using GLMakie

# ╔═╡ fd670b90-5d6d-11ec-02f5-f30d6bfaaef7
begin
	time = Node(0.0)
	...
	fig3 = Figure()
	axes3 = Axis(fig3[1,1], title = @lift("t = $(round($time, digits = 1))"),)
	...
	record(fig3, "time_animate.mp4", timestamps; framerate = framerate) do t
		time[] = t
	end
end
